...
import org.csu.farm.bean.enums.OrderStatus;
import org.csu.farm.bean.event.SubmitOrderEvent;
import org.csu.farm.bean.model.*;
import org.csu.farm.bean.model.*;
import org.csu.farm.bean.order.SubmitOrderOrder;
import org.csu.farm.common.exception.YamiShopBindException;
import org.csu.farm.common.util.Arith;
import org.csu.farm.dao.*;
...
public class SubmitOrderListener {
    ...
    public void defaultSubmitOrderListener(SubmitOrderEvent event) {
        ...
        for (ShopCartOrderDto shopCartOrderDto : shopCartOrders) {
            ...
            // 订单信息
            org.csu.farm.bean.model.Order order = new org.csu.farm.bean.model.Order();
